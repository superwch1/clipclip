 ...
 */
function UploadImageButton({scale, reverseActionsRef, boardIdRef, positionRef}) {

  const hiddenFileInputRef = useRef(null);
  
  return (
    <>
      <div id='control-menu-bar-image' onClick={(event) => createImage(hiddenFileInputRef)}>Upload</div>
