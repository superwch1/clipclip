...
import './CreatePreviewButton.css'
 ...
 */
function CreatePreviewButton({scale, reverseActionsRef, boardIdRef, positionRef}) {
  ...
  return (
    <>
      <div id='control-menu-bar-preview' ref={previewButtonRef} onClick={(event) => showInput(controlUrlId)}>Link</div>
